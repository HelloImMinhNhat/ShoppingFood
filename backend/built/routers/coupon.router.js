...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, coupon_model_1.couponModel.countDocuments()];
            case 1:
                ...
                return [4 /*yield*/, coupon_model_1.couponModel.create(data_1.sample_discounts)];
            case 2:
                _a.sent();
...
router.get("/", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, coupon_model_1.couponModel.find()];
            case 1:
                coupon = _a.sent();
                res.send(coupon);
                return [2 /*return*/];
...
router.get("/:id", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, coupon_model_1.couponModel.findById(req.params.id)];
            case 1:
                coupon = _a.sent();
                res.send(coupon);
                return [2 /*return*/];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, coupon_model_1.couponModel.find({ discountCode: { $regex: searchRegex } })];
            case 1:
                foods = _a.sent();
                res.send(foods);
                return [2 /*return*/];
...
router.post('/create', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, id, name, discountCode, discountPercent, discount, newDiscount, dbDiscount;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, id = _a.id, name = _a.name, discountCode = _a.discountCode, discountPercent = _a.discountPercent;
                return [4 /*yield*/, coupon_model_1.couponModel.findOne({ discountCode: discountCode })];
            case 1:
                discount = _b.sent();
                if (discount) {
                ...
                return [4 /*yield*/, coupon_model_1.couponModel.create(newDiscount)];
            case 2:
                dbDiscount = _b.sent();
...
router.put('/edit/:id', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                _a = req.body, name = _a.name, discountCode = _a.discountCode, discountPercent = _a.discountPercent;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, coupon_model_1.couponModel.findByIdAndUpdate(id, {
                        name: name,
                        discountCode: discountCode,
                        discountPercent: discountPercent
                    })];
            case 2:
                discount = _b.sent();
                if (!discount) {
                    res.status(http_status_1.HTTP_BAD_REQUEST).send('Không tìm thấy mã giảm giá');
                    return [2 /*return*/];
                }
            ...
            case 3:
                ...
                res.status(http_status_1.HTTP_BAD_REQUEST).send('Đã xảy ra lỗi khi cập nhật mã giảm giá');
                return [3 /*break*/, 4];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, coupon_model_1.couponModel.findByIdAndRemove(discountId)];
            case 1:
            ...
            case 2:
                error_2 = _a.sent();
                return [2 /*return*/, res.status(500).json({ error: 'Đã xảy ra lỗi khi xóa mã giảm giá' })];
