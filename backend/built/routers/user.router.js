...
router.post("/login", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                user = _d.sent();
                _b = (user === null || user === void 0 ? void 0 : user.isAdmin) == true && user;
            ...
            case 3:
                ...
                if (user) {
                    ...
                    res.status(http_status_1.HTTP_BAD_REQUEST).send("Tên đăng nhập hoặc mật khẩu không đúng!");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                if (user) {
                    res.status(http_status_1.HTTP_BAD_REQUEST)
                        .send('Tên đăng nhập đã tồn tại, Hãy đăng nhập!');
                    return [2 /*return*/];
                }
                return [4 /*yield*/, bcryptjs_1.default.hash(password, 10)];
            case 2:
