      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              order_model_1.OrderModel.deleteOne({
                user: req.user.id,
          ...
          case 1:
            ...
            newOrder = new order_model_1.OrderModel(
              __assign(__assign({}, requestOrder), { user: req.user.id })
            );
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            else res.status(http_status_1.HTTP_BAD_REQUEST).send();
            return [2 /*return*/];
        }
      });
    });
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            order_model_1.OrderModel.find({ user: userId }).exec(),
          ];
        case 2:
          orders = _a.sent();
          if (!orders) {
        ...
        case 3:
          error_1 = _a.sent();
          console.error("Lỗi khi lấy đơn hàng:", error_1);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              order_model_1.OrderModel.findById(req.params.id),
            ];
          case 1:
            order = _a.sent();
            res.send(order);
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [
            4 /*yield*/,
            order_model_1.OrderModel.findOne({
              user: req.user.id,
              status: order_status_1.OrderStatus.NEW,
            }),
          ];
