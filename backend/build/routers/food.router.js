        ...
        switch (_b.label) {
          case 0:
            (_a = req.body),
              ...
              (origins = _a.origins),
              (cookTime = _a.cookTime),
              (CateID = _a.CateID);
            return [
              4 /*yield*/,
              food_model_1.FoodModel.findOne({ name: name }),
            ];
          case 1:
            food = _b.sent();
            if (food) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              food_model_1.FoodModel.findByIdAndUpdate(id, {
                name: name,
                price: price,
                tags: tags,
                imageUrl: imageUrl,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            food_model_1.FoodModel.findByIdAndRemove(foodId),
          ];
        case 1:
          deletedFood = _a.sent();
          if (!deletedFood) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              food_model_1.FoodModel.create(data_1.sample_foods),
            ];
          case 2:
            _a.sent();
  ...
  (0, express_async_handler_1.default)(function (req, res) {
    return __awaiter(void 0, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, food_model_1.FoodModel.find()];
          case 1:
            foods = _a.sent();
            res.send(foods);
            return [2 /*return*/];
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [
              4 /*yield*/,
              food_model_1.FoodModel.aggregate([
                {
                  $unwind: "$category",
                },
                {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              food_model_1.FoodModel.find({ CateID: req.params.CateID }),
            ];
          case 1:
            foods = _a.sent();
            res.send(foods);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              food_model_1.FoodModel.findById(req.params.foodId),
            ];
          case 1:
            food = _a.sent();
            res.send(food);
