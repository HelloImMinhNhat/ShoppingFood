...
router.post('/create', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, id = _a.id, CateID = _a.CateID, name = _a.name;
                return [4 /*yield*/, category_model_1.CategoryModel.findOne({ name: name })];
            case 1:
                category = _b.sent();
                if (category) {
                ...
                return [4 /*yield*/, category_model_1.CategoryModel.create(newCategory)];
            case 2:
                dbCategory = _b.sent();
...
router.put('/edit/:id', (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, category_model_1.CategoryModel.findByIdAndUpdate(id, {
                        CateID: CateID,
                        name: name
                    })];
            case 2:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, category_model_1.CategoryModel.findByIdAndRemove(categoryId)];
            case 1:
                deletedCate = _a.sent();
                if (!deletedCate) {
                    res.status(http_status_1.HTTP_BAD_REQUEST).send('Không tìm thấy thực phẩm');
...
router.get("/seed", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, category_model_1.CategoryModel.countDocuments()];
            case 1:
                foodsCount = _a.sent();
                if (foodsCount > 0) {
                ...
                return [4 /*yield*/, category_model_1.CategoryModel.create(data_1.sample_category_food)];
            case 2:
                _a.sent();
...
router.get("/:cateId", (0, express_async_handler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var food;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, category_model_1.CategoryModel.findById(req.params.cateId)];
            case 1:
                food = _a.sent();
                res.send(food);
                return [2 /*return*/];
