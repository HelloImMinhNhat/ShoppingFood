...
exports.app.use(express_1.default.static(path_1.default.join(__dirname, '..', '..', 'frontend', 'dict')));
exports.app.get('*', function (req, res) {
    res.sendFile(path_1.default.join(__dirname, '..', '..', 'frontend', 'dict', 'index.html'));
});
